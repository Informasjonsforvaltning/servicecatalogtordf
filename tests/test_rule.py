...
def test_to_graph_should_return_rule_with_processing_time() -> None:
    """It returns a rule graph with cv:processingTime isomorphic to spec."""
    rule = Rule("http://example.com/rules/1")
    rule.processing_time = "PT15M"
